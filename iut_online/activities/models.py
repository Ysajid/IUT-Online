...
class Notification(models.Model):
    ...
    _LIKED_TEMPLATE = '<a href="/{0}/">{1}</a> liked your post: <a href="/posts/{2}/">{3}</a>'  # noqa: E501
    _COMMENTED_TEMPLATE = '<a href="/{0}/">{1}</a> commented on your post: <a href="/posts/{2}/">{3}</a>'  # noqa: E501
    ...
    _ALSO_COMMENTED_TEMPLATE = '<a href="/{0}/">{1}</a> also commentend on the post: <a href="/posts/{2}/">{3}</a>'  # noqa: E501
