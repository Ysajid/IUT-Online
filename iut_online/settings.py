# Django settings for iut_online project.
import os.path
...
DATABASES = {
    'default': {
        ...
        'NAME': 'iut',                      # Or path to database file if using sqlite3.
...
ROOT_URLCONF = 'iut_online.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'iut_online.wsgi.application'
...
# BOWER_COMPONENTS_ROOT = os.path.join(PROJECT_ROOT, 'iut_online/static/components/')
